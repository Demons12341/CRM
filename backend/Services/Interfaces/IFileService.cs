...
namespace ProjectManagementSystem.Services.Interfaces
{
    ...
    {
        Task<PaginatedResult<FileDto>> GetFilesByProjectIdAsync(int projectId, int? parentId, int? page, int? pageSize, string? keyword, bool recursive, int currentUserId);
        ...
        Task<PaginatedResult<FileDto>> GetRecycleBinFilesAsync(int? page, int? pageSize, string? keyword, int currentUserId);
        ...
        Task<FileDto> ShareFileAsync(int id, int userId);
        Task<FileDto> MakeFilePrivateAsync(int id, int userId);
    ...
    public class FileDto
    {
        ...
        public string LocationPath { get; set; } = "项目根目录";
